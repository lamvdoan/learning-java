...
public class SolutionDijkstraMain {
	public static void main(String[] args) {
		ArrayList<SolutionWeightedNode> nodeList = new ArrayList<>();
		
		//create 5 nodes: A,B,C,D,E
		for(int i=0;i<5; i++) {
			nodeList.add(new SolutionWeightedNode(""+(char)(65+i)));
		}
		
		//Constructor
		SolutionDijkstra graph = new SolutionDijkstra(nodeList);
